...
+ (void)enumerateLiveObjectsUsingBlock:(flex_object_enumeration_block_t)block
{
    ...
    if (result == KERN_SUCCESS) {
        for (unsigned int i = 0; i < zoneCount; i++) {
            ...
            BOOL b1 = lock_zone != NULL;
            BOOL b2 = unlock_zone != NULL;
            BOOL b3 = introspection->enumerator != NULL;
            BOOL b4 = (uintptr_t)lock_zone < MAX_REALISTIC_ADDRESS;
            BOOL b5 = (uintptr_t)unlock_zone < MAX_REALISTIC_ADDRESS;
